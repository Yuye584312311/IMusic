...
public class MainActivity extends BaseActivity {
    ...
    private void initAppService() {
        //未授予权限，弹窗提示
        PermissionModel[] models=new PermissionModel[]{
                new PermissionModel(Manifest.permission.WRITE_EXTERNAL_STORAGE, getResources().getString(R.string.splash_runtime_permission_tips), 102),
                new PermissionModel(Manifest.permission.READ_EXTERNAL_STORAGE, getResources().getString(R.string.splash_runtime_permission_tips), 103)};
        if(!RuntimePermissionManager.getInstance().isAllRequestedPermission(MainActivity.this,models)){
            PermissQuireDialog.getInstance(MainActivity.this)
                    .setTitleText("向您申请权限")
                    .setContentText(getResources().getString(R.string.splash_runtime_permission_tips))
                    .setSubmitTitleText("确定")
                    .setCancelTitleText("取消")
                    .setDialogCancelable(false)
                    .setDialogCanceledOnTouchOutside(false)
                    .setTopImageRes(R.drawable.ad_ic_permission_bg)
                    .setOnQueraConsentListener(new PermissQuireDialog.OnQueraConsentListener() {
                        @Override
    ...
    private void initMainService() {
        RuntimePermissionManager.getInstance().startRequstPermission(MainActivity.this,"0",new OnRuntimePermissionListener() {
            @Override
            public PermissionModel[] getRequstPermissions() {
                PermissionModel[] models=new PermissionModel[]{
                        new PermissionModel(Manifest.permission.WRITE_EXTERNAL_STORAGE, getResources().getString(R.string.splash_runtime_permission_tips), 102),
                        new PermissionModel(Manifest.permission.READ_EXTERNAL_STORAGE, getResources().getString(R.string.splash_runtime_permission_tips), 103)};
                return models;
            ...
            @Override
            public String getErrorPermissionTips() {
                return getResources().getString(R.string.splash_runtime_permission_tips)+"是否立即前往设置?";
            }

            @Override
            public void onRequstPermissionResult(boolean success) {
                if(!success){
                    RuntimePermissionDialog permissionDialog = RuntimePermissionDialog.getInstance(MainActivity.this)
                            .setDialogCancelable(false)
                            .setTipsContent(getResources().getString(R.string.splash_runtime_permission_tips))
                            .setDialogCanceledOnTouchOutside(false);
